...
public class Page extends JPanel
{
  ...
  private void initLayout() {
    ...
    label.setIcon(new ImageIcon(
      Page.class
      .getResource("/com/careflow/resource/image/page_first.gif")));
    ...
    label1.setIcon(new ImageIcon(
      Page.class.getResource("/com/careflow/resource/image/page_prev.gif")));
    ...
    label2.setIcon(new ImageIcon(
      Page.class
      .getResource("/com/careflow/resource/image/page_next.gif")));
    ...
    label3.setIcon(new ImageIcon(
      Page.class
      .getResource("/com/careflow/resource/image/page_last.gif")));
    ...
    label11.setIcon(new ImageIcon(Page.class.getResource("/com/careflow/resource/image/save.gif")));
