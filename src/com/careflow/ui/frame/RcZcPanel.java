...
import com.careflow.moudle.DailyExpensesMoudle;
...
import com.careflow.util.DateHelper;
  ...
  implements IPage
{
  ...
  private RcZcPanel() {
    ...
    ImageIcon imageIcon1 = new ImageIcon(OptionsTypePanel.class.getResource("/com/careflow/resource/image/zhichu.png"));
    ...
    ImageIcon imageIcon2 = new ImageIcon(OptionsTypePanel.class.getResource("/com/careflow/resource/image/shouru.png"));
    ...
    this.table_1.addMouseListener(new MouseAdapter() {
      public void mouseClicked(MouseEvent e) {
        RcZcPanel.this.clickedTable("确定删除此条数据?", "删除收入数据", RcZcPanel.this.table_1);
      }
    });
