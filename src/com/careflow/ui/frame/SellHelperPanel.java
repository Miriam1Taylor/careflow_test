...
import com.careflow.ui.widget.CashDialog;
import com.careflow.ui.widget.SellDialog;
  ...
  private SellHelperPanel()
  {
    ...
    button.addMouseListener(new MouseAdapter() {
      public void mouseClicked(MouseEvent arg0) {
        SellDialog sellDialog = new SellDialog(SellHelperPanel.sellHelperPanel, SellHelperPanel.this.table,
                SellHelperPanel.this.label_16, SellHelperPanel.this.lbll);
        sellDialog.setVisible(true);
      }
    });
    button.setPreferredSize(new Dimension(57, 50));
    button.setSelectedIcon(new ImageIcon(SellHelperPanel.class
      .getResource("/com/careflow/resource/image/50.png")));
    button.setPreferredSize(new Dimension(57, 50));
...
//    panel_4.add(button_1, gbc_button_1);
    ...
    JLabel lblqq = new JLabel(
      "欢迎使用Careflow ERP记账系统，Careflow ERP记账系统是完全免费使用的软件，如需帮助请加入Careflow ERPQQ群:746780476");
